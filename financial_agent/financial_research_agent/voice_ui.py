"""
Voice UI components - extracted from manager.py to separate concerns.
Contains the Textual-based voice interaction UI (RealtimeApp).
"""
...
class AudioStatusIndicator(Static):
    ...
    def render(self) -> str:
        status = (
            "[REC] Recording... (Press K to stop)"
            if self.is_recording
            else "[IDLE] Press K to start recording (Q to quit)"
        )
        return status
